...
![Hero screenshot: Chess Openings Coach home screen](screenshots/home-screen-hero.png)
...
![Screenshot: White Repertoire screen with board and Coach pane](screenshots/repertoire-white-coach.png)
...
![Screenshot: Coach pane explaining a position](screenshots/coach-pane.png)
...
![Screenshot: Grandmaster Tree with popularity and W/D/L bars](screenshots/gm-tree-bars.png)
...
![Screenshot: Live Tree showing user game statistics](screenshots/live-tree.png)
...
![Screenshot: Live Tree Analysis dialog](screenshots/live-tree-analysis.png)
...
![Screenshot: Trainer Queen database search](screenshots/trainer-queen-search.png)
...
![Screenshot: PGN Reader with right-side analysis pane](screenshots/pgn-reader.png)
...
![Screenshot: Computer Analysis pane with soft engine arrows](screenshots/computer-analysis.png)
...
![Screenshot: Repertoire screen overview](screenshots/repertoire-screen-overview.png)
...
![Screenshot: Board with arrows and highlights](screenshots/board-arrows.png)
...
![Screenshot: Repertoire screen splitter](screenshots/repertoire-splitter.png)
...
![Screenshot: Coach pane move chips](screenshots/coach-move-chips.png)
...
![Screenshot: PGN Reader main layout](screenshots/pgn-reader-main.png)
...
![Screenshot: PGN Reader controls](screenshots/pgn-reader-controls.png)
...
![Screenshot: Build Live Repertoire](screenshots/build-live-repertoire.png)
...
![Screenshot: Backup and restore dialog](screenshots/backup-restore-dialog.png)
...
![Screenshot: Pro Database Pack dialog](screenshots/pro-dialog.png)
